...
Η εφαρμογή **StudyRooms** είναι ένα σύστημα κράτησης χώρων μελέτης που επιτρέπει
την προβολή διαθέσιμων δωματίων, την εγγραφή και αυθεντικοποίηση χρηστών,
καθώς και τη δημιουργία και ακύρωση κρατήσεων μέσω γραφικής διεπαφής και REST API.
